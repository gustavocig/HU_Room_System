...
// Further modifications done for HU's Room Management project: Gustavo Cignachi
// Purpose of file:
// ----------------------------------------------------------------------
...
class PluginRoomRoom extends CommonDBTM {
    ...
    function showForm($ID, $options = array()) {
        ...
        // Computer
        echo "<tr class='tab_bg_1'><td>" . $LANG['plugin_room'][23] . ":		</td>";
        echo "<td>";
        ...
        echo "<td>";
        Dropdown::showYesNo("tv", $this->fields["tv"]);
        echo "</td></tr>";
        ...
        // Opening hours
        echo "<td>" . $LANG['plugin_room'][11] . ":		</td>";
        echo "<td colspan='3'>";
