...
class Html
{
    ...
    /**
     * Include favicon icons in all differente resolutions and formats, to support different devices
     *
     * @param nothing
     *
     * @return nothing
     **/
    static function includeFaviconIcons()
    {
        global $CFG_GLPI;

        // Old favicon icon used by GLPI
        //echo "<link rel='shortcut icon' type='images/x-icon' href='".
        //       $CFG_GLPI["root_doc"]."/pics/favicon.ico' >\n";

        // Favicon icons in different formats and resolutions
        echo "<link rel='apple-touch-icon' sizes='57x57' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-57x57.png'>";
        echo "<link rel='apple-touch-icon' sizes='60x60' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-60x60.png'>";
        echo "<link rel='apple-touch-icon' sizes='72x72' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-72x72.png'>";
        echo "<link rel='apple-touch-icon' sizes='76x76' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-76x76.png'>";
        echo "<link rel='apple-touch-icon' sizes='114x114' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-114x114.png'>";
        echo "<link rel='apple-touch-icon' sizes='120x120' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-120x120.png'>";
        echo "<link rel='apple-touch-icon' sizes='144x144' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-144x144.png'>";
        echo "<link rel='apple-touch-icon' sizes='152x152' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-152x152.png'>";
        echo "<link rel='apple-touch-icon' sizes='180x180' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/apple-icon-180x180.png'>";
        echo "<link rel='icon' type='image/png' sizes='192x192'  href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/android-icon-192x192.png'>";
        echo "<link rel='icon' type='image/png' sizes='32x32' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/favicon-32x32.png'>";
        echo "<link rel='icon' type='image/png' sizes='96x96' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/favicon-96x96.png'>";
        echo "<link rel='icon' type='image/png' sizes='16x16' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/favicon-16x16.png'>";
        echo "<link rel='manifest' href='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/manifest.json'>";
        echo "<meta name='msapplication-TileColor' content='#ffffff'>";
        echo "<meta name='msapplication-TileImage' content='" .
            $CFG_GLPI["root_doc"] . "/pics/favicon_icons/ms-icon-144x144.png'>";
    ...
    static function includeHeader($title = '')
    {
        ...
        // Start the page
        echo "<!DOCTYPE html>";
        echo "\n<html><head><title>HU - " . $title . "</title>";
...
//          echo 'menu load';
        ...
        echo "<div id='c_logo'>";
        echo Html::link('', $CFG_GLPI["root_doc"] . "/front/reservation.php",
            array('accesskey' => '1',
                'title' => __('Home')));
        echo "</div>";

        echo "<div id='c_logo2'></div>";
...
*/
        ...
        // Display item
        echo "<li class='breadcrumb_item'><a href='" . $CFG_GLPI["root_doc"] . "/front/reservation.php' title=\"" . __s('Home') . "\">" . __('Home') . "</a></li>";

        if (isset($menu[$sector])) {
            $link = "/front/reservation.php";
    ...
    static function displayMenuAll($menu = array())
    {
        ...
        //#HOLDAT Adicionado controle de permissao para apenas usuario 'glpi' conseguir acessar menu geral
        ...
        /// Toggle menu to appear only to 'glpi' user
        if ($_SESSION['glpiname'] == 'glpi') {
